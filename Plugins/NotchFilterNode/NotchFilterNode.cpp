...
double NotchFilterNode::getLowCutValueForChannel (int chan) const
{
    return lowCuts[chan];
}


double NotchFilterNode::getHighCutValueForChannel (int chan) const
{
...
void NotchFilterNode::setFilterParameters (double lowCut, double highCut, int chan)
{
    ...
    params[1] = 2;                          // order
    params[2] = highCut;     // center frequency
    params[3] = lowCut;           // bandwidth
